...
<template>
    <div v-motion-slide-visible-once-bottom class="grid gap-1 content-center justify-items-center text-center lg:py-20 lg:w-2/3 mx-auto">
        ...
        <Button variant="secondary" link="mailto:dialaegwuchukwu@gmail.com" target="_blank" class="group relative mt-6 md:w-fit text-center overflow-hidden" v-umami="'Contact-Me'">
            Contact Me
