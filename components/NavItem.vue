...
<template>
    <li>
        <NuxtLink ref="link" :to="to" v-bind="$attrs" active-class="active" exact-active-class="exact" :class="(!!isActive || route.path.startsWith(to)) ? 'active' : ''" class="relative inline-block text-zinc-800 dark:text-zinc-200 px-3 py-2 transition hover:text-emerald-500 dark:hover:text-emerald-400">
            {{ label }}
